...
Public Class CalendarYearlyView
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "frm2.CalendarYearlyView.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCalendarYearlyView
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CalendarYearlyView = New CalendarYearlyView()
        rpt.Site = Me.Site
        Return rpt
    End Function
